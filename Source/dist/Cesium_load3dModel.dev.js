...
var scene = viewer.scene; //viewer.extend(Cesium.viewerCesium3DTilesInspectorMixin);
...
if (Cesium.PostProcessStageLibrary.isSilhouetteSupported(viewer.scene)) {
  var Compara = function Compara(name1, name2) {
    var j = 0; //console.log(code_name1);
  ...
  viewer.screenSpaceEventHandler.setInputAction(function onLeftClick(movement) {
    ...
    string_description + '</tbody></table>';
  ...
  viewer.screenSpaceEventHandler.setInputAction(function onLeftClick(movement) {
    ...
    selectedEntity.name = featureName;
    selectedEntity.description = 'Loading <div class="cesium-infoBox-loading"></div>';
    viewer.selectedEntity = selectedEntity; //modificado
    ...
    selectedEntity.description = '<table class="cesium-infoBox-defaultTable"><tbody>' + //'<tr><th>BIN</th><td>' + pickedFeature.getProperty('BIN') + '</td></tr>' +
    //'<tr><th>DOITT ID</th><td>' + pickedFeature.getProperty('DOITT_ID') + '</td></tr>' +
    //'<tr><th>SOURCE ID</th><td>' + pickedFeature.getProperty('SOURCE_ID') + '</td></tr>' +
    //'<tr><th>Longitude</th><td>' + pickedFeature.getProperty('longitude') + '</td></tr>' +
    //'<tr><th>Latitude</th><td>' + pickedFeature.getProperty('latitude') + '</td></tr>' +
